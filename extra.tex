...
\begin{enumerate}
  ...
  \item Dokument dodatkowy nr 2 — Jak rozwiązaliśmy wątpliwości
  \item Dokument dodatkowy nr 3 — Proces emisji akcji — checklista informacyjna
  \item Dokument dodatkowy nr 4 — Proces podejmowania decyzji i zarządzania Spółką
  \item Dokument dodatkowy nr 5 — Akcjonariusz Funkcjonalny — wyjaśnienie wspólnej kategorii
  \item Dokument dodatkowy nr 6 — Audyt paragraf po paragrafie — zgodność i podstawa prawna
  \item Dokument dodatkowy nr 7 — Mapa przygotowania pod rundę inwestycyjną
  \item Dokument dodatkowy nr 8 — Punkty do weryfikacji podatkowej
\end{enumerate}
...
\clearpage
\section*{Dokument dodatkowy nr 2 — Jak rozwiązaliśmy wątpliwości}
\addcontentsline{toc}{section}{Dokument dodatkowy nr 2 — Jak rozwiązaliśmy wątpliwości}
...
\clearpage
\section*{Dokument dodatkowy nr 3 — Proces emisji akcji — checklista informacyjna}
\addcontentsline{toc}{section}{Dokument dodatkowy nr 3 — Proces emisji akcji — checklista informacyjna}
...
\clearpage
\section*{Dokument dodatkowy nr 4 — Proces podejmowania decyzji i zarządzania Spółką}
\addcontentsline{toc}{section}{Dokument dodatkowy nr 4 — Proces podejmowania decyzji i zarządzania Spółką}
...
\clearpage
\section*{Dokument dodatkowy nr 5 — Akcjonariusz Funkcjonalny — wyjaśnienie wspólnej kategorii}
\addcontentsline{toc}{section}{Dokument dodatkowy nr 5 — Akcjonariusz Funkcjonalny — wyjaśnienie wspólnej kategorii}
...
Sposób wejścia do Spółki & objęcie akcji przy zawiązaniu Spółki --- §~\ref{art:cap-table} & kwalifikacja, uchwała emisyjna i objęcie akcji serii F --- §~\ref{art:seria-f}; proces informacyjnie opisuje Dokument dodatkowy nr 3 \\
\bottomrule
\end{longtable}
...
\clearpage
\section*{Dokument dodatkowy nr 6 — Audyt paragraf po paragrafie — zgodność i podstawa prawna}
\addcontentsline{toc}{section}{Dokument dodatkowy nr 6 — Audyt paragraf po paragrafie — zgodność i podstawa prawna}
...
\clearpage
\section*{Dokument dodatkowy nr 7 — Mapa przygotowania pod rundę inwestycyjną}
\addcontentsline{toc}{section}{Dokument dodatkowy nr 7 — Mapa przygotowania pod rundę inwestycyjną}
...
\clearpage
\section*{Dokument dodatkowy nr 8 — Punkty do weryfikacji podatkowej}
\addcontentsline{toc}{section}{Dokument dodatkowy nr 8 — Punkty do weryfikacji podatkowej}
\label{annex:podatki}
