...
\begin{enumerate}
  \item prawo przymusowego współzbycia --- może zostać uruchomione przez akcjonariuszy posiadających 90\% wszystkich głosów (§~\ref{art:przymusowe-wspolzbycie});
...
\begin{enumerate}
  ...
  \item \textbf{Progi kwotowe i zakres budżetu} (§~\ref{art:rada-zastrzezone} ust.~1 lit.~a, c--d; §~\ref{art:walne-zastrzezone} ust.~1 lit.~j).
  ...
  \item \textbf{Pula programu motywacyjnego:} pozostawić jako uśpioną opcję albo usunąć dla uproszczenia umowy (§~\ref{art:program-motywacyjny}).
