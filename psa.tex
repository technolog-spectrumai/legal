% Generated using the supplied basilisk_i18n style; content: Basilisk Systems P.S.A. agreement + comments/graphics.
...
\begin{enumerate}
  ...
  \item Spółka rozwija w szczególności rozwiązania dla zastosowań cywilnych, przemysłowych, ratowniczych, infrastrukturalnych, bezpieczeństwa i obronności, przy zachowaniu zgodności z prawem, zasadami odpowiedzialnego rozwoju technologii oraz wymogami bezpieczeństwa państw Unii Europejskiej i Organizacji Traktatu Północnoatlantyckiego.
...
\begin{enumerate}
  ...
  \begin{enumerate}[label=\alph*)]
    \item osoba fizyczna będąca obywatelem co najmniej jednego państwa członkowskiego Unii Europejskiej lub Organizacji Traktatu Północnoatlantyckiego; albo
    \item osoba prawna lub jednostka organizacyjna posiadająca siedzibę i rzeczywiste centrum zarządzania w państwie członkowskim Unii Europejskiej lub Organizacji Traktatu Północnoatlantyckiego, która nie jest bezpośrednio ani pośrednio kontrolowana przez osobę lub podmiot niespełniający powyższego kryterium i której beneficjenci rzeczywiści spełniają kryterium określone w lit. a).
  \end{enumerate}
  ...
  \begin{enumerate}[label=\alph*)]
    ...
    \item kontrolowany przez państwo, służby, siły zbrojne albo podmiot z jurysdykcji spoza Unii Europejskiej i Organizacji Traktatu Północnoatlantyckiego;
    \item którego udział stwarza racjonalnie uzasadnione ryzyko dla bezpieczeństwa Spółki, jej technologii, kontraktów, zezwoleń, programu NATO DIANA lub innych programów sojuszniczych;
  ...
  \item Złagodzenie lub uchylenie postanowień niniejszego paragrafu, a także ustanowienie jakiegokolwiek wyjątku dla podmiotu spoza Unii Europejskiej i Organizacji Traktatu Północnoatlantyckiego, wymaga jednomyślnej uchwały obejmującej 100\% wszystkich głosów oraz pozytywnej opinii wszystkich dyrektorów niewykonawczych odpowiedzialnych za bezpieczeństwo.
\end{enumerate}
...
\begin{enumerate}
  ...
  \end{enumerate}
  \item Uchwały dotyczące dopuszczenia inwestora, nabywcy lub podmiotu kontrolującego spoza Unii Europejskiej i Organizacji Traktatu Północnoatlantyckiego, jak również złagodzenia §~\ref{art:dopuszczalny-nabywca}, wymagają jednomyślności obejmującej 100\% wszystkich głosów i nie mogą naruszać bezwzględnie obowiązujących przepisów bezpieczeństwa, sankcji ani kontroli eksportu.
...
\begin{enumerate}
  ...
  \item Dostęp z jurysdykcji spoza Unii Europejskiej i Organizacji Traktatu Północnoatlantyckiego do Kluczowej Własności Intelektualnej wymaga uprzedniej pisemnej zgody Rady Dyrektorów i analizy kontroli eksportu; zgoda nie może zostać udzielona, jeżeli byłoby to sprzeczne z §~\ref{art:dopuszczalny-nabywca} lub prawem.
\end{enumerate}
...
\section*{6. Ograniczenie inwestorów do UE i NATO}
\addcontentsline{toc}{section}{6. Ograniczenie inwestorów do UE i NATO}
...
Tak restrykcyjne ograniczenie powinno zostać sprawdzone przed podpisaniem pod kątem prawa Unii Europejskiej, zasad przepływu kapitału, przepisów o inwestycjach zagranicznych, sankcji, AML, rejestru akcjonariuszy i wykonalności wobec pośrednich struktur funduszy. Może ono wykluczać także inwestorów z bliskich państw partnerskich, które nie należą ani do UE, ani do NATO. Zgodnie z decyzją założycielską projekt nie przewiduje zwykłego wyjątku; jego wprowadzenie wymagałoby jednomyślności wszystkich głosów.
\end{RiskBox}
...
\begin{itemize}
  ...
  \item obowiązek, aby każdy końcowy nabywca należał do dozwolonego kręgu UE/NATO.
\end{itemize}
...
Przed rozmowami z NATO DIANA lub inwestorem należy przygotować „data room” obejmujący:
\begin{itemize}
...
\section*{10. Dual-use, kontrola eksportu i gotowość do NATO DIANA}
\addcontentsline{toc}{section}{10. Dual-use, kontrola eksportu i gotowość do NATO DIANA}
...
\begin{itemize}
  ...
  \item rozporządzenia Parlamentu Europejskiego i Rady (UE) 2021/821 ustanawiającego unijny system kontroli wywozu, pośrednictwa, pomocy technicznej, tranzytu i transferu produktów podwójnego zastosowania, w aktualnym brzmieniu;
