...
\begin{enumerate}
  ...
  \item Załączniki nr 4--12 mają wyłącznie charakter informacyjny i porządkujący, nie stanowią części normatywnej niniejszej umowy i nie tworzą samodzielnych praw ani obowiązków.
\end{enumerate}
\end{ContractClause}
...
\clearpage
\section*{Załącznik nr 12 — Profil produkcyjny a profil startupowy — mapa postanowień umowy}
\addcontentsline{toc}{section}{Załącznik nr 12 — Profil produkcyjny a profil startupowy — mapa postanowień umowy}
...
\textbf{B6.} Wyłączenie pracy i usług jako wkładu na akcje serii A & §~\ref{art:wklady} ust.~2 & \textbf{U} & Upraszcza wycenę i sytuację podatkową w obu profilach (Załącznik nr~11). Wkład w postaci pracy --- cecha P.S.A. typowa dla startupów --- pozostaje możliwy tylko dla serii F (§~\ref{art:seria-f} ust.~7). \\
...
\textbf{C4.} Wyłączenia spod zgody Spółki: prawo pierwszeństwa, prawo przyłączenia, przymusowe współzbycie, zwrotne zbycie, Kwalifikowana Runda & §~\ref{art:zbywanie} ust.~7 & \textbf{S} & Wyłączenia obsługują mechanizmy właściwe profilowi S (drag-along, vesting, runda); w profilu P praktyczne znaczenie ma głównie wyłączenie dla prawa pierwszeństwa. \\
...
\textbf{F3.} Kwalifikowana Runda Finansowania: definicja, uchwała kierunkowa, zobowiązanie współdziałania, katalog zwyczajowych warunków inwestorskich & §~\ref{art:kwalifikowana-runda}; Załącznik nr~10 & \textbf{S} & Paragraf w całości startupowy (uprzywilejowanie likwidacyjne, ochrona antyrozwodnieniowa, dyrektor inwestora, pro-rata). W profilu P nie wywołuje skutków, dopóki Walne Zgromadzenie nie podejmie uchwały kierunkowej większością 75\% (ust.~2). \\
...
Nr 10 --- Mapa przygotowania pod rundę inwestycyjną & \textbf{S} & W całości startupowy. \\
Nr 11 --- Punkty do weryfikacji podatkowej & \textbf{U} & Pkt~1 (ESOP w P.S.A.) dotyczy profilu S; pkt~2 (aport własności intelektualnej) obu profili; pkt~3 (wkłady pieniężne, pożyczki założycielskie) głównie profilu P. \\
\bottomrule
\end{longtable}
...
\begin{enumerate}
  ...
  \item Kwalifikowana Runda Finansowania --- wymaga uchwały kierunkowej (§~\ref{art:kwalifikowana-runda} ust.~2);
