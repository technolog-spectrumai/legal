...
\begin{enumerate}
  ...
  \item \BoilerplateStrike{Działalność wymagająca koncesji, zezwolenia, licencji, certyfikacji, wpisu do rejestru albo poświadczenia bezpieczeństwa może być rozpoczęta dopiero po spełnieniu odpowiednich wymogów.}
\end{enumerate}
...
\item \BoilerplateStrike{Działalność podlegająca koncesji, zezwoleniu, licencji, certyfikacji albo innym szczególnym wymogom może być rozpoczęta dopiero po spełnieniu wymagań wynikających z właściwych przepisów prawa.}
\end{enumerate}
\end{ContractClause}
...
\label{art:seria-f}
\begin{enumerate}
  \item „Założycielem Funkcjonalnym Serii F” może zostać wyłącznie osoba fizyczna, która po zawiązaniu Spółki obejmuje trwałą, strategiczną i osobistą odpowiedzialność za istotny obszar rozwoju Spółki, porównywalną co do znaczenia z rolą Założyciela Pierwotnego, oraz zobowiązuje się do długoterminowego, istotnego zaangażowania operacyjnego w rozwój Spółki. Pełnienie funkcji pracownika, współpracownika, dyrektora albo doradcy nie stanowi samodzielnej podstawy do nadania statusu Założyciela Funkcjonalnego Serii F.
  ...
  \item Uchwała o nadaniu statusu Założyciela Funkcjonalnego Serii F ma charakter kwalifikacyjny; nie stanowi oferty objęcia akcji ani nie kreuje bezwarunkowego roszczenia o ich objęcie. Przed złożeniem przez Spółkę wiążącej oferty objęcia akcji Walne Zgromadzenie może większością 75\% wszystkich głosów cofnąć nadany status, jeżeli dana osoba przestała spełniać kryteria określone w ust. 1 lub warunki uchwały kwalifikacyjnej. Po zawarciu umowy objęcia i powstaniu akcji status prawny tych akcji określają właściwe przepisy prawa, niniejsza umowa oraz mechanizm zwrotnego zbycia. Uchwała o utracie statusu Założyciela Funkcjonalnego Serii F nie wywołuje skutku rozporządzającego i nie pozbawia akcjonariusza praw z już powstałych akcji.
  ...
  \item Do akcji serii F stosuje się postanowienia dotyczące Dopuszczalnego Nabywcy, Prawnie Niedopuszczalnego Posiadacza, prawa pierwszeństwa, prawa przyłączenia, prawa przymusowego współzbycia oraz ograniczenia zbywania określonego w §~\ref{art:okres-ograniczenia-zbywania}. Dla Założyciela Funkcjonalnego Serii F 24-miesięczny Okres Ograniczenia Zbywania Akcji liczy się od jego Dnia Przyznania Serii F.
  \item Seria F jest odrębna od serii P. Emisja akcji serii F nie pomniejsza puli programu motywacyjnego serii P. Przyznanie akcji serii P tej samej osobie wymaga odrębnej podstawy i nie jest zaliczane na limit serii F.
\end{enumerate}
\end{ContractClause}
...
\begin{enumerate}
  ...
  \end{enumerate}
  \item Objęcie akcji obowiązkiem zbycia nie pozbawia praw korporacyjnych związanych z tymi akcjami; do chwili zwolnienia z tego obowiązku akcje pozostają jednak objęte obowiązkiem zbycia w przypadkach określonych w niniejszym paragrafie.
  ...
  \begin{enumerate}[label=\alph*)]
    ...
    \item postanowienia niniejszego ustępu nie wyłączają roszczeń Spółki o naprawienie szkody ani zastosowania innych środków ochrony prawnej.
  \end{enumerate}
...
\begin{enumerate}
  ...
  \item Narodowość, obywatelstwo, siedziba, miejsce zamieszkania albo jurysdykcja pochodzenia nabywcy nie stanowią samodzielnej podstawy odmowy uznania go za Dopuszczalnego Nabywcę, jeżeli nabycie akcji przez tę osobę lub podmiot jest zgodne z bezwzględnie obowiązującymi przepisami prawa.
  ...
  \item Brak wystarczających informacji do zakończenia weryfikacji nie stanowi podstawy do uznania osoby za Niedopuszczalnego Nabywcę; w takim przypadku zakończenie transakcji ulega wstrzymaniu do czasu uzyskania informacji koniecznych do ustalenia jej prawnej dopuszczalności.
  \item Status Prawnie Niedopuszczalnego Posiadacza wynika z właściwej podstawy prawnej, a Rada Dyrektorów wyłącznie dokumentuje jego wystąpienie w formie uchwały albo protokołu, wskazując konkretną podstawę prawną oraz zakres wynikającego z niej zakazu, ograniczenia lub obowiązku. Pogorszenie oceny reputacyjnej, politycznej albo biznesowej akcjonariusza nie stanowi podstawy uznania go za Prawnie Niedopuszczalnego Posiadacza.
  \item Uzyskanie statusu Prawnie Niedopuszczalnego Posiadacza nie skutkuje automatycznie powstaniem obowiązku zbycia akcji. Spółka i akcjonariusz stosują środki wymagane przez bezwzględnie obowiązujące przepisy prawa. Jeżeli właściwe przepisy dopuszczają usunięcie stanu prawnej niedopuszczalności przez zbycie akcji, akcjonariusz jest zobowiązany dokonać zbycia na rzecz Dopuszczalnego Nabywcy niezwłocznie po dniu, w którym takie zbycie stało się prawnie dopuszczalne. Do tego czasu wykonywanie praw, otrzymywanie świadczeń, rozporządzanie akcjami oraz inne czynności dotyczące akcji podlegają ograniczeniom wynikającym z właściwych przepisów prawa.
...
\begin{enumerate}
  ...
  \item \BoilerplateStrike{Nabycie albo ustalenie przynależności akcji w związku ze stosunkami majątkowymi małżeńskimi następuje zgodnie z bezwzględnie obowiązującymi przepisami prawa.} Objęcie akcji wspólnością majątkową małżeńską albo ustanie tej wspólności nie skutkuje wobec Spółki uzyskaniem przez drugiego małżonka statusu akcjonariusza ani samodzielnego uprawnienia do wykonywania praw korporacyjnych. Jeżeli zgodnie z prawem powstanie współuprawnienie z akcji, prawa wobec Spółki wykonuje się zgodnie z właściwymi przepisami KSH, w szczególności art. 300$^{38}$ KSH.
  \item Jeżeli wskutek prawomocnego orzeczenia sądu, ugody, umowy o podział majątku albo innego prawnie skutecznego zdarzenia małżonek albo były małżonek skutecznie nabędzie akcje, do takiego nabywcy stosuje się postanowienia niniejszej umowy dotyczące Dopuszczalnego Nabywcy oraz --- jeżeli po skutecznym nabyciu powstanie odpowiednia podstawa prawna --- Prawnie Niedopuszczalnego Posiadacza. Postanowienia niniejszego paragrafu nie uchylają zakazów wynikających z bezwzględnie obowiązujących przepisów prawa ani nie stanowią podstawy nabycia akcji.
...
\begin{enumerate}
  ...
  \item Na potrzeby niniejszego paragrafu „Osobą Bliską” jest współmałżonek dyrektora oraz jego krewny lub powinowaty do drugiego stopnia włącznie. Stopień pokrewieństwa oraz linię i stopień powinowactwa ustala się zgodnie z art. 61$^{7}$ § 2 oraz art. 61$^{8}$ § 2 Kodeksu rodzinnego i opiekuńczego. Pokrewieństwo lub powinowactwo dalsze niż drugi stopień nie powoduje objęcia danej osoby definicją Osoby Bliskiej. Odrębnie, przy ocenie konfliktu interesów uwzględnia się osobiste powiązanie dyrektora z inną osobą w rozumieniu art. 300$^{55}$ § 1 KSH, niezależnie od istnienia lub stopnia pokrewieństwa albo powinowactwa. „Podmiotem Powiązanym z Dyrektorem” jest podmiot, w którym dyrektor, jego Osoba Bliska albo podmiot przez nich kontrolowany:
  \begin{enumerate}[label=\alph*)]
...
\begin{enumerate}
  ...
  \item Załączniki nr 4--8 mają wyłącznie charakter informacyjny i porządkujący, nie stanowią części normatywnej niniejszej umowy i nie tworzą samodzielnych praw ani obowiązków.
\end{enumerate}
\end{ContractClause}
...
\begin{enumerate}
  ...
  \item \textbf{Prawo rozporządzania akcjami w granicach umowy i prawa.} Akcjonariusz może zbyć lub obciążyć akcje na rzecz Dopuszczalnego Nabywcy po spełnieniu właściwych ograniczeń i procedur --- §~\ref{art:dopuszczalny-nabywca}, §~\ref{art:zbywanie}, §~\ref{art:pierwszenstwo} oraz, jeżeli ma zastosowanie, §~\ref{art:okres-ograniczenia-zbywania}.
  ...
  \item \textbf{Ochrona przed przymusowym dalszym finansowaniem.} Posiadanie akcji nie zobowiązuje akcjonariusza do dalszego finansowania Spółki; dodatkowe finansowanie wymaga jego odrębnej pisemnej zgody --- §~\ref{art:finansowanie}.
...
\begin{enumerate}
  ...
  \item \textbf{Okres Ograniczenia Zbywania Akcji.} Założyciel Pierwotny przez 24 miesiące od wpisu Spółki do rejestru podlega ograniczeniu zbywania i obciążania akcji, z wyjątkami wskazanymi w umowie — §~\ref{art:okres-ograniczenia-zbywania}.
...
\begin{enumerate}
  ...
  \item \textbf{Okres Ograniczenia Zbywania Akcji serii F.} Założyciel Funkcjonalny Serii F podlega 24-miesięcznemu ograniczeniu zbywania liczonym od Dnia Przyznania Serii F — §~\ref{art:seria-f} i §~\ref{art:okres-ograniczenia-zbywania}.
...
„Brak wystarczających informacji do zakończenia weryfikacji nie stanowi podstawy do uznania osoby za Niedopuszczalnego Nabywcę; w takim przypadku zakończenie transakcji ulega wstrzymaniu do czasu uzyskania informacji koniecznych do ustalenia jej prawnej dopuszczalności.”
\end{quote}
...
\textbf{Wątpliwość.} Czy objęcie akcji majątkiem wspólnym albo ustanie wspólności majątkowej skutkuje uzyskaniem przez drugiego małżonka statusu akcjonariusza i czy wymaga odrębnego mechanizmu przymusowego wykupu za 100\% Wartości Godziwej?
...
\textbf{Po:}
\begin{quote}\small
„Objęcie akcji wspólnością majątkową małżeńską albo ustanie tej wspólności nie skutkuje wobec Spółki uzyskaniem przez drugiego małżonka statusu akcjonariusza ani samodzielnego uprawnienia do wykonywania praw korporacyjnych.”
...
\clearpage
\section*{Załącznik nr 6 — Proces emisji akcji — procedura informacyjna}
\addcontentsline{toc}{section}{Załącznik nr 6 — Proces emisji akcji — procedura informacyjna}
...
\textbf{Terminologia ustawowa.} Zgodnie z art. 4 § 2$^{1}$ KSH, jeżeli w przepisach KSH poza art. 300$^{52}$--300$^{67}$ mowa jest o zarządzie albo członku zarządu, w P.S.A. z Radą Dyrektorów należy przez to rozumieć odpowiednio Radę Dyrektorów albo dyrektora. Dlatego niniejsza procedura posługuje się terminologią organów przyjętą w niniejszej umowie. \href{https://eli.gov.pl/api/acts/DU/2024/18/text.html}{Podstawa: art. 4 § 2$^{1}$ KSH}.

\subsection*{1. Ustalenie podstawy prawnej emisji}
...
Jeżeli emisja wymaga zmiany umowy Spółki, zawiadomienie powinno również wskazywać dotychczasowe postanowienia i projektowane zmiany. Uchwałę dotyczącą zmiany umowy Spółki umieszcza się w protokole sporządzonym przez notariusza. Emisja serii F albo P mieszcząca się w istniejącej podstawie z art. 300$^{103}$ KSH nie wymaga zastosowania trybu zmiany umowy Spółki.
...
\begin{enumerate}
  \item \textbf{Uchwała o emisji.} Każda emisja wymaga uchwały Walnego Zgromadzenia podjętej większością 75\% wszystkich głosów w Spółce zgodnie z §~\ref{art:walne-zastrzezone}. Dla serii F stosuje się dodatkowo §~\ref{art:seria-f}, a dla serii P --- §~\ref{art:program-motywacyjny}.
...
\begin{enumerate}
  \item Walne Zgromadzenie większością 75\% wszystkich głosów nadaje kandydatowi status Założyciela Funkcjonalnego Serii F i określa jego rolę strategiczną, minimalne zaangażowanie, maksymalną liczbę akcji i Dzień Przyznania Serii F;
...
\begin{enumerate}
  ...
  \item dla serii F zaktualizować dokumentację Dnia Przyznania, mechanizmu zwrotnego zbycia i 24-miesięcznego ograniczenia zbywania;
...
\subsection*{13. Skrócony wykaz dokumentów}
...
\subsection*{7. Oddzielenie uchwały od czynności wykonawczej — reprezentacja Spółki}
...
Powołanie prokurenta wymaga zgody wszystkich dyrektorów; odwołanie prokury może nastąpić przez każdego dyrektora. Jeżeli stroną umowy albo sporu ze Spółką jest dyrektor, stosuje się szczególny sposób reprezentacji określony w §~\ref{art:reprezentacja} i art. 300$^{79}$ KSH. Zatwierdzenie transakcji przez Radę albo Walne Zgromadzenie nie zastępuje wymaganego sposobu reprezentacji Spółki.

\textbf{Podstawa prawna:} \href{https://eli.gov.pl/api/acts/DU/2024/18/text.html}{art. 300$^{75}$ § 3 oraz art. 300$^{79}$ KSH}.

\subsection*{8. Zalecany cykl zarządzania operacyjnego}

Poniższy cykl ma charakter organizacyjnej rekomendacji i nie ustanawia dodatkowych obowiązków korporacyjnych:
\begin{enumerate}
  \item \textbf{na bieżąco} — dyrektorzy wykonawczy prowadzą działalność w ramach delegacji, budżetu i polityk; istotne odstępstwa są przedstawiane Radzie Dyrektorów do rozstrzygnięcia;
  ...
  \item \textbf{niezwłocznie} — incydenty bezpieczeństwa, konflikty interesów, ryzyka sankcyjne lub związane z kontrolą eksportu oraz zdarzenia mogące zagrozić płynności są niezwłocznie przedstawiane właściwemu organowi zgodnie z odpowiednimi postanowieniami umowy.
\end{enumerate}

Opisany cykl może zostać uszczegółowiony w Regulaminie Rady Dyrektorów, o którym mowa w §~\ref{art:rada}.
...
\subsection*{11. Skrócony schemat postępowania decyzyjnego}

\begin{enumerate}
  \item \textbf{Ustalenie przedmiotu sprawy.}
  \item \textbf{Ustalenie właściwości:} decyzja operacyjna / Rada Dyrektorów / Walne Zgromadzenie.
  \item \textbf{Weryfikacja progów:} budżet, 100 000 zł, 500 000 zł, 75\%, cztery piąte albo inny próg szczególny.
  \item \textbf{Weryfikacja warunków szczególnych:} konflikt interesów, własność intelektualna, bezpieczeństwo, kontrola eksportu, sankcje, finansowanie.
  \item \textbf{Przygotowanie Karty decyzji i projektu uchwały}, jeżeli uchwała jest wymagana.
  \item \textbf{Podjęcie decyzji} przez właściwy organ i utrwalenie wyniku.
  \item \textbf{Weryfikacja zasad reprezentacji} przed podpisaniem dokumentów.
  \item \textbf{Wykonanie decyzji} przez wskazaną osobę w określonym terminie i zakresie.
  \item \textbf{Zakończenie procesu} przez wpis do rejestru decyzji i dołączenie dokumentów potwierdzających wykonanie.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \textbf{Ograniczenie zbywania.} Obie grupy podlegają 24-miesięcznemu Okresowi Ograniczenia Zbywania Akcji, z odmiennym momentem rozpoczęcia właściwym dla każdej grupy --- §~\ref{art:okres-ograniczenia-zbywania}; dla Serii F także §~\ref{art:seria-f}.
...
\begin{enumerate}
  ...
  \item \textbf{Standard Wartości Godziwej.} W odniesieniu do zwolnionych akcji objętych prawem nabycia przy Odejściu Zawinionym umowa odwołuje się do 80\% Wartości Godziwej, nie mniej niż cena emisyjna; zasady wyceny określa §~\ref{art:wycena}, natomiast mechanizm nabycia określa §~\ref{art:zwrotne-zbycie}.
...
Początek 24-miesięcznego ograniczenia zbywania & dzień wpisu Spółki do rejestru --- §~\ref{art:okres-ograniczenia-zbywania} & Dzień Przyznania Serii F --- §~\ref{art:seria-f} i §~\ref{art:okres-ograniczenia-zbywania} \\
