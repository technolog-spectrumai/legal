...
\BusinessPlanConfidentialText{Projekt umowy --- rewizja 0.9.3 (Etapy 1--2)}
\BusinessPlanFooterText{Basilisk Systems --- umowa P.S.A.}
\BusinessPlanVersionText{Wersja 0.9.3 --- zmiany oznaczone}
...
\BusinessPlanTitlePage
  {Basilisk Systems}
  {Wersja 0.9.3 --- zmiany oznaczone}
  {Umowa P.S.A.}
  {Projekt umowy prostej spółki akcyjnej}
  {Rewizja z oznaczonymi zmianami [ZMIANA 1--16], komentarzami i poprzednim brzmieniem}
  {0.9.3}

\tableofcontents
\newpage

\section*{Nota rewizyjna — wykaz zmian rewizji 0.9}
\addcontentsline{toc}{section}{Nota rewizyjna — wykaz zmian rewizji 0.9}

\textbf{Status noty.} Nota ma charakter wyłącznie informacyjny i porządkujący; nie stanowi części normatywnej umowy. Każda zmiana jest oznaczona w tekście blokiem \textbf{[ZMIANA n --- KOMENTARZ]}, znacznikami \textbf{[ZMIENIONO]} / \textbf{[NOWE]} przy poszczególnych ustępach oraz blokiem \textbf{[BYŁO]} zawierającym dosłowne poprzednie brzmienie --- w celu umożliwienia ręcznej weryfikacji. Fragmenty przekreślone pozostają, jak dotąd, przeznaczone do usunięcia, z wyjątkiem klauzul koncesyjnych przywróconych w ramach ZMIANY 2.

\begin{enumerate}
  \item \textbf{[ZMIANA 1]} §~\ref{art:cel} i §~\ref{art:pkd} --- odwrócenie hierarchii celu: głównym przedmiotem działalności jest fizyczna (ucieleśniona) sztuczna inteligencja i systemy autonomiczne, a bezzałogowe statki powietrzne są ich pierwszym zastosowaniem; zmiana działalności przeważającej PKD.
  \item \textbf{[ZMIANA 2]} §~\ref{art:cel} ust.~4 i §~\ref{art:pkd} --- przywrócenie (cofnięcie przekreślenia) klauzul koncesyjnych wraz z doprecyzowaniem podstawy: ustawa z 13 czerwca 2019 r. o wykonywaniu działalności gospodarczej w zakresie wytwarzania i obrotu materiałami wybuchowymi, bronią, amunicją oraz wyrobami i technologią o przeznaczeniu wojskowym lub policyjnym (Dz.U. 2019 poz.~1214 ze zm.).
  \item \textbf{[ZMIANA 3]} §~\ref{art:dopuszczalny-nabywca}, §~\ref{art:zbywanie}, §~\ref{art:okres-ograniczenia-zbywania}, §~\ref{art:rada} ust.~3 --- wprowadzenie Kryterium Bezpieczeństwa EU/NATO oraz reżimu zgody Spółki na rozporządzenie akcją opartego wprost na art.~300$^{39}$ KSH (odmowa wyłącznie z przyczyn obiektywnych, wskazanie innego nabywcy, Wartość Godziwa); lock-up 12-miesięczny osadzony w tym samym mechanizmie.
  \item \textbf{[ZMIANA 4]} §~\ref{art:rada} ust.~2 i §~\ref{art:walne-zastrzezone} --- obniżenie progu dla \emph{powołania} dyrektorów do bezwzględnej większości głosów oddanych (75\% wszystkich głosów pozostaje dla odwołania bez ważnych powodów) oraz mechanizm ciągłości Rady.
  \item \textbf{[ZMIANA 5]} §~\ref{art:zwrotne-zbycie} --- wyodrębnienie „Odejścia Dobrowolnego” jako kategorii pośredniej: dobrowolne odejście przestaje być Odejściem Zawinionym; akcje zwolnione pozostają przy odchodzącym (z opcją nabycia po 100\% Wartości Godziwej), akcje niezwolnione podlegają zbyciu po cenie emisyjnej.
  \item \textbf{[ZMIANA 6]} nowy §~\ref{art:kwalifikowana-runda} --- Kwalifikowana Runda Finansowania: zdefiniowany tryb współdziałania przy rundzie inwestycyjnej i katalog zwyczajowych warunków inwestorskich; mapa paragrafów przygotowujących rundę w Załączniku nr~10.
  \item \textbf{[ZMIANA 7]} §~\ref{art:wklady} i Załącznik nr~1 --- dopuszczenie wkładów pieniężnych obok niepieniężnych, przeznaczenie wkładów pieniężnych na kapitał akcyjny; korekta rachunkowa kolumny „Cena łączna” w Załączniku nr~1 (dotychczasowe kwoty były dziesięciokrotnie zawyżone względem ceny emisyjnej 0,01~zł).
  \item \textbf{[ZMIANA 8]} §~\ref{art:wz} --- Walne Zgromadzenie zawsze z miejscem fizycznym, uczestnictwo elektroniczne jako tryb (art.~300$^{92}$ KSH), zawiadomienia na adres e-mail \emph{wpisany do rejestru akcjonariuszy} (art.~300$^{87}$ KSH) --- domknięcie punktu 4 audytu.
  \item \textbf{[ZMIANA 9]} §~\ref{art:dziedziczenie} --- osadzenie mechanizmu wprost w art.~300$^{41}$ KSH (ograniczenie wstąpienia spadkobierców z określonymi warunkami spłaty pod rygorem bezskuteczności) --- domknięcie punktu 3 audytu.
  \item \textbf{[ZMIANA 10]} §~\ref{art:konkurencja} ust.~8 --- fallback uchwały Walnego Zgromadzenia ograniczony do spraw, w których uchwały Rady nie wymaga sama ustawa; gdzie ustawa wymaga uchwały Rady, transakcja czeka na uzupełnienie składu Rady --- domknięcie punktu 5 audytu.
  \item \textbf{[ZMIANA 11]} Załączniki --- aktualizacja Załączników nr~1, 4 i 8; nowy Załącznik nr~10 (mapa paragrafów pod rundę inwestycyjną) i nr~11 (punkty do weryfikacji podatkowej, w tym ESOP w P.S.A. a art.~24 ust.~11--12b PIT); nota do Załącznika nr~9 (audyt dotyczy wersji 0.8).
\end{enumerate}

\textbf{Wykaz zmian rewizji 0.9.3 (Etapy 1--2 planu poprawek).} Rewizja 0.9.3 obejmuje wyłącznie poprawki spójności rewizji 0.9 (Etap 1: szczelność Kryterium Bezpieczeństwa EU/NATO; Etap 2: domknięcie Odejścia Dobrowolnego). Etapy 3--5 (tempo kontraktowania, decyzje strategiczne, zbiorczy re-audyt) świadomie NIE zostały wprowadzone i pozostają do odrębnych rewizji.

\begin{enumerate}
  \setcounter{enumi}{11}
  \item \textbf{[ZMIANA 12]} §~\ref{art:zbywanie} ust.~7 --- uszczelnienie: wyłączenie wymogu zgody Spółki (pierwszeństwo, przyłączenie, przymusowe współzbycie, zwrotne zbycie, Kwalifikowana Runda) nie uchyla wymogu Kryterium Bezpieczeństwa EU/NATO; przy przymusowym współzbyciu Kryterium weryfikuje się przed doręczeniem zawiadomienia o wykonaniu prawa.
  \item \textbf{[ZMIANA 13]} §~\ref{art:okres-ograniczenia-zbywania} ust.~2 lit.~a --- zastąpienie niezdefiniowanego pojęcia „zatwierdzonej rundy finansowania” odwołaniem do Kwalifikowanej Rundy Finansowania albo innej rundy zatwierdzonej uchwałą WZ większością 75\% wszystkich głosów.
  \item \textbf{[ZMIANA 14]} §~\ref{art:dziedziczenie} ust.~1--2 i §~\ref{art:malzonek} ust.~3 --- rozszerzenie warunków wstąpienia spadkobiercy oraz nabycia akcji przez małżonka o Kryterium Bezpieczeństwa EU/NATO (z możliwością zgody WZ); DECYZJA DO POTWIERDZENIA przez Założycieli.
  \item \textbf{[ZMIANA 15]} §~\ref{art:zwrotne-zbycie}, definicja Odejścia Zawinionego lit.~e --- doprecyzowanie, że rezygnacja z zachowaniem co najmniej 30-dniowego okresu przejściowego i należytym wykonywaniem obowiązków nie stanowi porzucenia obowiązków; usuwa ryzyko „wchłonięcia” Odejścia Dobrowolnego przez lit.~e.
  \item \textbf{[ZMIANA 16]} §~\ref{art:zwrotne-zbycie} (umowa wykonawcza), §~\ref{art:seria-f} ust.~10 oraz Załącznik nr~4 --- uzupełnienie enumeracji o Odejście Dobrowolne i tryb wykonania 6-miesięcznego prawa nabycia akcji zwolnionych.
\end{enumerate}

\textbf{Relacja do audytu (Załącznik nr~9).} Zmiany 3, 8, 9 i 10 odpowiadają punktom 2, 4, 3 i 5 „Podsumowania audytu”; punkt 1 audytu (obowiązki przyszłego nabywcy) adresuje nowy ustęp w §~\ref{art:dopuszczalny-nabywca}. Wszystkie zmienione paragrafy wymagają ponownego audytu prawnego w zmienionym zakresie.
\newpage
...
\label{art:wklady}
\ZmianaKomentarz{7}{Dopuszczono wkłady pieniężne obok niepieniężnych. Dotychczas akcje obejmowano wyłącznie za IP i sprzęt, przez co Spółka rodziła się bez gotówki --- a P.S.A. nie zna instytucji dopłat znanej ze spółki z o.o. Wkłady pieniężne (kwoty w Załączniku nr~1) są w całości przeznaczane na kapitał akcyjny i wnoszone przed wpisem do rejestru, co zapewnia środki operacyjne od pierwszego dnia. Dodano też wyraźne odesłanie do pożyczek założycielskich. Wyłączenie pracy i usług jako wkładu pozostaje bez zmian (świadomie --- upraszcza wycenę i sytuację podatkową).}
\begin{enumerate}
  \item \ZM Akcje serii A są obejmowane w zamian za wkłady niepieniężne oraz wkłady pieniężne, w postaci:
  \begin{enumerate}[label=\alph*)]
    ...
    \item \NOWE wkładów pieniężnych w kwotach określonych w Załączniku nr 1.
  \end{enumerate}
  ...
  \item \ZM Wartość przypisana każdemu wkładowi niepieniężnemu oraz kwota wkładu pieniężnego każdego Założyciela są określone w Załączniku nr 1. Łączna wartość wkładów przypisanych danemu Założycielowi odpowiada co najmniej łącznej cenie emisyjnej obejmowanych przez niego akcji.
  \item \ZM Na kapitał akcyjny przeznacza się wkłady pieniężne w łącznej kwocie określonej w Załączniku nr 1, nie niższej niż 1,00 zł. Przed złożeniem wniosku o wpis Spółki do rejestru Założyciele wniosą w całości wkłady pieniężne. Pozostałe wkłady zostaną wniesione najpóźniej w terminie 14 dni od dnia wpisu Spółki do rejestru przedsiębiorców. Dokumenty rozporządzające prawami własności intelektualnej powinny zostać podpisane najpóźniej w dniu zawarcia niniejszej umowy, ze skutkiem dla Spółki w organizacji albo — jeżeli wymaga tego charakter prawa — ze skutkiem na dzień wpisu Spółki do rejestru.
  ...
  \item \NOWE Niezależnie od wkładów Założyciel może udzielić Spółce pożyczki na warunkach rynkowych; do takiej pożyczki stosuje się §~\ref{art:finansowanie} oraz §~\ref{art:transakcje-akcjonariusze}.
\end{enumerate}

\begin{Bylo}
ust.~1, zdanie wprowadzające: „Akcje serii A są obejmowane wyłącznie w zamian za wkłady niepieniężne w postaci:” (bez lit.~d).

ust.~3: „Wartość przypisana każdemu wkładowi niepieniężnemu jest określona w Załączniku nr 1. Łączna wartość wkładów przypisanych danemu Założycielowi odpowiada co najmniej łącznej cenie emisyjnej obejmowanych przez niego akcji.”

ust.~4, zdania pierwsze i drugie: „Przed złożeniem wniosku o wpis Spółki do rejestru Założyciele wniosą wkłady przeznaczone na kapitał akcyjny o łącznej wartości co najmniej 1,00 zł. Pozostałe wkłady zostaną wniesione najpóźniej w terminie 14 dni od dnia wpisu Spółki do rejestru przedsiębiorców.”
...
\ZmianaKomentarz{11}{Treść normatywna paragrafu BEZ ZMIAN. Dodano wyłącznie niniejszy wskaźnik: opodatkowanie objęcia akcji serii P po cenie emisyjnej 0,01 zł oraz stosowalność preferencji z art.~24 ust.~11--12b ustawy o PIT do prostej spółki akcyjnej to znany punkt sporny --- omówienie i zalecenie wystąpienia o interpretację indywidualną przed pierwszym grantem zawiera NOWY Załącznik nr~11.}
\begin{enumerate}
...
\label{art:seria-f}
\ZmianaKomentarz{16}{Rewizja 0.9.3 (Etap 2). W ust.~10 uzupełniono enumerację zasad stosowanych do Założyciela Funkcjonalnego Serii F o Odejście Dobrowolne (wyliczenie po słowach „w tym” było przykładowe, więc pominięcie nie zmieniało normy, ale groziło sporem interpretacyjnym).}
\begin{enumerate}
...
\begin{Bylo}
Rewizja 0.9.3 --- ust.~10 w brzmieniu rewizji 0.9 (i 0.8) wymieniał „[...] w tym zasady Odejścia Usprawiedliwionego, Odejścia Zawinionego, przyspieszonego zwolnienia [...]” --- bez Odejścia Dobrowolnego.
\end{Bylo}
\end{ContractClause}
...
\ZmianaKomentarz{15}{Rewizja 0.9.3 (Etap 2). Doprecyzowanie lit.~e definicji Odejścia Zawinionego: rezygnacja jest w praktyce „odmową dalszego wykonywania obowiązków”, a definicja Odejścia Dobrowolnego wyklucza je przy wystąpieniu jakiegokolwiek zdarzenia z katalogu Zawinionego --- Spółka w konflikcie z odchodzącym miała więc gotowy argument, by każdą rezygnację przekwalifikować na Zawinione (80\% zamiast 100\% Wartości Godziwej za akcje zwolnione). Po zmianie rezygnacja z zachowaniem co najmniej 30-dniowego okresu przejściowego i należytym wykonywaniem obowiązków w tym okresie nie wypełnia lit.~e; pozostałe litery (a--d) stosują się bez zmian, więc realne przewinienia nadal wyłączają kwalifikację Dobrowolną.}
\ZmianaKomentarz{16}{Rewizja 0.9.3 (Etap 2). Enumeracja w ustępie o odrębnej umowie wykonawczej nie nadążyła za ZMIANĄ 5: wymieniała tylko stwierdzanie Odejścia Usprawiedliwionego i Zawinionego, choć przy Odejściu Dobrowolnym umowa wykonawcza musi obsłużyć zarówno obowiązkowe zbycie akcji niezwolnionych, jak i 6-miesięczną opcję nabycia akcji zwolnionych po 100\% Wartości Godziwej. Uzupełniono; analogiczne uzupełnienia enumeracji w §~\ref{art:seria-f} ust.~10 i w Załączniku nr~4 (informacyjnym).}
\ZmianaKomentarz{5}{Wyodrębniono trzecią kategorię --- „Odejście Dobrowolne”. Dotychczas dobrowolne odejście przed upływem 48 miesięcy było Odejściem Zawinionym, co pozwalało odebrać także akcje już zwolnione (vested) za 80\% Wartości Godziwej. To ostrzejsze niż standard rynkowy i zniechęca kandydatów na Założycieli Funkcjonalnych Serii F. Po zmianie: przy Odejściu Dobrowolnym akcje niezwolnione podlegają zbyciu po cenie emisyjnej (jak dotąd), akcje zwolnione pozostają przy odchodzącym, a Spółka ma jedynie terminową opcję wskazania nabywcy po pełnej (100\%) Wartości Godziwej. Odejście Zawinione zarezerwowano wyłącznie dla realnych przewinień (lit.~a--e).}
\begin{enumerate}
  ...
  \end{enumerate}
  \item \ZM „Odejście Zawinione” oznacza wyłącznie ustanie zaangażowania w związku z co najmniej jednym z następujących zdarzeń:
  \begin{enumerate}[label=\alph*)]
  ...
  \end{enumerate}
  \item \NOWE W przypadku Odejścia Dobrowolnego:
  \begin{enumerate}[label=\alph*)]
    \item akcje nadal podlegające obowiązkowi zbycia podlegają zbyciu na rzecz wskazanego przez Spółkę Dopuszczalnego Nabywcy po cenie równej ich cenie emisyjnej;
...
\begin{Bylo}
Definicja Odejścia Zawinionego zawierała dodatkową lit.~f: „dobrowolnym odejściem przed upływem 48 miesięcy bez zgody Walnego Zgromadzenia i bez okoliczności stanowiącej Odejście Usprawiedliwione.” --- lit.~f usunięto; jej zakres przejęła nowa kategoria „Odejście Dobrowolne”.

Definicja „Odejścia Dobrowolnego” oraz ustęp o skutkach Odejścia Dobrowolnego nie istniały; skutki dobrowolnego odejścia wynikały z reżimu Odejścia Zawinionego (zbycie akcji niezwolnionych po cenie emisyjnej oraz prawo nabycia akcji zwolnionych po 80\% Wartości Godziwej).

Rewizja 0.9.3 --- lit.~e w brzmieniu rewizji 0.9 (i 0.8): „porzuceniem obowiązków albo odmową ich wykonywania przez co najmniej 30 dni po bezskutecznym pisemnym wezwaniu.” (bez zdania o rezygnacji z okresem przejściowym). Ustęp o umowie wykonawczej w brzmieniu rewizji 0.9 (i 0.8) wymieniał „sposób stwierdzenia Odejścia Usprawiedliwionego albo Odejścia Zawinionego” --- bez Odejścia Dobrowolnego i trybu wykonania prawa nabycia akcji zwolnionych.
\end{Bylo}
\end{ContractClause}
...
\label{art:zbywanie}
\ZmianaKomentarz{12}{Rewizja 0.9.3 (Etap 1). Uszczelnienie ust.~7: w rewizji 0.9 ścieżki wyłączone spod zgody Spółki (pierwszeństwo, przyłączenie, przymusowe współzbycie, zwrotne zbycie, Kwalifikowana Runda) zachowywały wyłącznie test Dopuszczalnego Nabywcy (sankcyjny), a Kryterium Bezpieczeństwa EU/NATO było egzekwowane tylko „w trybie zgody” --- powstawała pętla odesłań i realna luka: przymusowe współzbycie (sprzedaż do 100\%) mogło ominąć bramkę EU/NATO, czyli ścieżkę najbardziej wrażliwą dla kwalifikowalności do EDF/DIANA. Po zmianie Kryterium (z override'em WZ 75\%) obowiązuje niezależnie od wyłączenia zgody; wyjątek pozostaje tylko dla egzekucji (art.~300$^{39}$ §~6 KSH --- wyłączenia umowne nie są tam skuteczne). Moment weryfikacji przy drag-along ustalono przed doręczeniem zawiadomienia, żeby mniejszość nie była zmuszana do zbycia w transakcji, która i tak nie przejdzie bramki.}
...
Rewizja 0.9.3 --- ust.~7 w brzmieniu rewizji 0.9 kończył się na słowach „[...] weryfikacja, czy nabywca jest Dopuszczalnym Nabywcą, pozostaje jednak wymagana w każdym przypadku.” --- bez zdań o Kryterium Bezpieczeństwa EU/NATO, momencie weryfikacji przy przymusowym współzbyciu i wyjątku egzekucyjnym.
\end{Bylo}
\end{ContractClause}
\begin{ContractClause}{Okres Ograniczenia Zbywania Akcji Założycieli}
\label{art:okres-ograniczenia-zbywania}
\ZmianaKomentarz{13}{Rewizja 0.9.3 (Etap 1). W ust.~2 lit.~a rewizja 0.9 posługiwała się niezdefiniowanym pojęciem „zatwierdzonej rundy finansowania”, podczas gdy umowa definiuje „Kwalifikowaną Rundę Finansowania” (§~\ref{art:kwalifikowana-runda}) --- niespójność terminologiczna groziła sporem, czy wyjątek od lock-upu obejmuje rundy poniżej progu Kwalifikowanej Rundy. Rozstrzygnięto szeroko: wyjątek obejmuje Kwalifikowaną Rundę oraz każdą inną rundę zatwierdzoną przez WZ większością 75\% wszystkich głosów (ta sama większość, która może uchylić lock-up w trybie ust.~1, więc nie osłabia to ochrony). Dodano „objęcie akcji”, bo udział w rundzie to objęcie nowych akcji, nie zbycie.}
...
\begin{enumerate}
  ...
  \begin{enumerate}[label=\alph*)]
    \item \ZM zbycia albo objęcia akcji w ramach Kwalifikowanej Rundy Finansowania (§~\ref{art:kwalifikowana-runda}) albo innej rundy finansowania zatwierdzonej uchwałą Walnego Zgromadzenia podjętą większością 75\% wszystkich głosów;
...
Rewizja 0.9.3 --- ust.~2 lit.~a w brzmieniu rewizji 0.9 (i 0.8): „zbycia w ramach zatwierdzonej rundy finansowania;”.
\end{Bylo}
\end{ContractClause}
...
\ZmianaKomentarz{14}{Rewizja 0.9.3 (Etap 1) --- DECYZJA DO POTWIERDZENIA przez Założycieli. W rewizji 0.9 spadkobierca przechodził wyłącznie weryfikację Dopuszczalnego Nabywcy (test sankcyjny), więc osoba spoza EU/NATO wstępowała do Spółki bez żadnej bramki --- niespójnie z celem ZMIANY 3 (ochrona struktury właścicielskiej pod EDF/DIANA i zamówienia obronne). Po zmianie spadkobierca niespełniający Kryterium Bezpieczeństwa EU/NATO wstępuje tylko za zgodą WZ (75\%); bez tej zgody jest spadkobiercą niewstępującym ze spłatą 100\% Wartości Godziwej --- mechanizm spłaty z art.~300$^{41}$ KSH pozostaje bez zmian, zmienia się wyłącznie katalog warunków wstąpienia. ALTERNATYWA (jeżeli Założyciele uznają ochronę rodzin za ważniejszą): pozostawić brzmienie 0.9 i dopisać w komentarzu ZMIANY 3, że dziedziczenie jest świadomym wyjątkiem od Kryterium. Ryzyko wariantu przyjętego: spłata 100\% FV rodziny zmarłego wymaga realnych środków --- ubezpieczenie z ust.~6 staje się praktycznie obowiązkowe.}
\ZmianaKomentarz{9}{Domknięcie punktu~3 „Podsumowania audytu”: dotychczasowa 90-dniowa procedura i obowiązkowe zbycie nie miały jasnej relacji do przejścia akcji z mocy prawa. Mechanizm osadzono wprost w art.~300$^{41}$ §~1 KSH, który pozwala umową ograniczyć lub wyłączyć wstąpienie spadkobierców do spółki, pod warunkiem określenia w umowie warunków spłaty spadkobierców niewstępujących --- pod rygorem bezskuteczności ograniczenia. Warunki spłaty określono wprost: 100\% Wartości Godziwej (§~\ref{art:wycena}) płatnej na zasadach ratalnych z ust.~5. Dotychczasowe obowiązkowe zbycie zachowano jako mechanizm rezerwowy. DO WERYFIKACJI PRZEZ PRAWNIKA: technika wykonania spłaty i los akcji spadkobierców niewstępujących (nabycie przez wskazanego Dopuszczalnego Nabywcę, ewentualnie nabycie własne albo umorzenie w trybie ustawowym) oraz zgodność 90-dniowego terminu z art.~300$^{41}$ KSH.}
\begin{enumerate}
  \item \ZM Na podstawie art.~300$^{41}$ §~1 KSH wstąpienie do Spółki spadkobierców na miejsce zmarłego akcjonariusza jest ograniczone w sposób określony w niniejszym paragrafie. Spadkobierca wstępuje do Spółki i może wykonywać prawa z akcji po wykazaniu następstwa prawnego oraz przejściu weryfikacji Dopuszczalnego Nabywcy zgodnie z §~\ref{art:dopuszczalny-nabywca}, a jeżeli nie spełnia Kryterium Bezpieczeństwa EU/NATO --- także po uzyskaniu zgody Walnego Zgromadzenia zgodnie z §~\ref{art:dopuszczalny-nabywca}.
  \item \ZM Spadkobierca, który nie jest Dopuszczalnym Nabywcą, który nie spełnia Kryterium Bezpieczeństwa EU/NATO i w terminie 90 dni od wezwania nie uzyskał zgody Walnego Zgromadzenia zgodnie z §~\ref{art:dopuszczalny-nabywca}, albo który nie przedstawi wymaganych informacji w terminie 90 dni od wezwania, nie wstępuje do Spółki. Spadkobiercy niewstępującemu przysługuje spłata w wysokości 100\% Wartości Godziwej akcji przypadających mu ze spadku, ustalonej zgodnie z §~\ref{art:wycena} na dzień otwarcia spadku, płatna na zasadach określonych w ust.~5; warunki spłaty określa się na podstawie art.~300$^{41}$ §~1 zdanie drugie KSH. Akcje spadkobiercy niewstępującego podlegają nabyciu przez wskazanego przez Spółkę Dopuszczalnego Nabywcę za cenę równą spłacie; jeżeli mechanizm ograniczenia wstąpienia okazałby się w danym przypadku bezskuteczny, akcje podlegają obowiązkowemu zbyciu na rzecz wskazanego przez Spółkę Dopuszczalnego Nabywcy za Wartość Godziwą.
...
\begin{Bylo}
ust.~1: „Spadkobierca może wykonywać prawa z akcji po wykazaniu następstwa prawnego oraz przejściu weryfikacji Dopuszczalnego Nabywcy.”

ust.~2: „Jeżeli spadkobierca nie jest Dopuszczalnym Nabywcą albo nie przedstawi wymaganych informacji w terminie 90 dni od wezwania, akcje podlegają obowiązkowemu zbyciu na rzecz wskazanego przez Spółkę Dopuszczalnego Nabywcy za Wartość Godziwą.”

Brak było odwołania do art.~300$^{41}$ KSH i wyraźnie określonych warunków spłaty spadkobierców niewstępujących.

Rewizja 0.9.3 --- w brzmieniu rewizji 0.9: ust.~1 kończył się na słowach „[...] przejściu weryfikacji Dopuszczalnego Nabywcy zgodnie z §~[Dopuszczalny Nabywca].” (bez warunku Kryterium Bezpieczeństwa EU/NATO), a ust.~2 zaczynał się od słów „Spadkobierca, który nie jest Dopuszczalnym Nabywcą albo nie przedstawi wymaganych informacji w terminie 90 dni od wezwania, nie wstępuje do Spółki.” (bez przesłanki braku Kryterium i zgody WZ).
\end{Bylo}
\end{ContractClause}

\begin{ContractClause}{Stosunki majątkowe małżeńskie i akcje}
\label{art:malzonek}
\ZmianaKomentarz{14}{Rewizja 0.9.3 (Etap 1) --- spójnie ze zmianą w §~\ref{art:dziedziczenie}: nabycie akcji przez małżonka (podział majątku, orzeczenie sądu) było w rewizji 0.9 drugą ścieżką wejścia do Spółki omijającą Kryterium Bezpieczeństwa EU/NATO. Rozszerzono odesłanie w ust.~3; pierwszeństwo rozliczenia pieniężnego bez przenoszenia akcji (ust.~4) pozostaje bez zmian i dodatkowo ogranicza praktyczne ryzyko. DECYZJA DO POTWIERDZENIA razem z wariantem dla spadkobierców.}
\begin{enumerate}
...
\begin{Bylo}
Rewizja 0.9.3 --- ust.~3 w brzmieniu rewizji 0.9 (i 0.8) odsyłał wyłącznie do „postanowień niniejszej umowy dotyczących Dopuszczalnego Nabywcy oraz [...] Prawnie Niedopuszczalnego Posiadacza” --- bez Kryterium Bezpieczeństwa EU/NATO.
\end{Bylo}
\end{ContractClause}
...
\label{art:rada}
\ZmianaKomentarz{4}{Usunięto magnes na paraliż: przy cap table 50/20/10/10/10 żadna dwójka Założycieli nie osiąga 75\% wszystkich głosów, więc nieobecność lub bierność jednego z większych akcjonariuszy blokowała obsadę Rady --- a mechanizm impasu z §~\ref{art:impas} wprost nie obejmuje spraw personalnych. Po zmianie: powołanie dyrektora --- bezwzględna większość głosów oddanych; odwołanie z ważnych powodów --- bezwzględna większość głosów oddanych; odwołanie bez ważnych powodów przed upływem kadencji --- nadal 75\% wszystkich głosów (ochrona przed wrogim czyszczeniem Rady). Dodano ust.~o ciągłości mandatu do powołania następcy (maks.~6 miesięcy) --- DO WERYFIKACJI PRZEZ PRAWNIKA dopuszczalność prorogacji mandatu w P.S.A.}
...
\begin{enumerate}
  ...
  \item \ZM Rada Dyrektorów składa się z 3 do 7 dyrektorów. Dyrektorów powołuje Walne Zgromadzenie uchwałą podjętą bezwzględną większością głosów oddanych. Odwołanie dyrektora przed upływem kadencji z ważnych powodów następuje uchwałą podjętą bezwzględną większością głosów oddanych, a bez ważnych powodów --- uchwałą podjętą większością 75\% wszystkich głosów.
...
\begin{Bylo}
ust.~2: „Rada Dyrektorów składa się z 3 do 7 dyrektorów, powoływanych i odwoływanych uchwałą Walnego Zgromadzenia podjętą większością 75\% wszystkich głosów.”
...
ust.~4 (ciągłość mandatu i żądanie zwołania WZ): nie istniał.
\end{Bylo}
\end{ContractClause}
...
\label{art:wz}
\ZmianaKomentarz{8}{Domknięcie punktu~4 „Podsumowania audytu”. Po pierwsze: art.~300$^{88}$ KSH wskazuje miejsce Walnego Zgromadzenia, a art.~300$^{92}$ reguluje jedynie elektroniczne \emph{uczestnictwo} --- dotychczasowe sformułowanie („albo z wykorzystaniem środków komunikacji elektronicznej”) mogło być czytane jako w pełni wirtualne WZ bez miejsca, co jest wątpliwe. Po zmianie WZ ma zawsze miejsce fizyczne (siedziba Spółki albo Warszawa), a udział elektroniczny jest trybem uczestnictwa. Po drugie: art.~300$^{87}$ KSH przewiduje zwołanie na adres e-mail \emph{wpisany do rejestru akcjonariuszy} --- adres jedynie „wskazany Spółce” może nie spełniać ustawowego sposobu doręczenia, więc go usunięto, dodając obowiązek wpisania i aktualizacji adresu w rejestrze.}
\begin{enumerate}
...
\begin{Bylo}
ust.~2: „Walne Zgromadzenia mogą odbywać się w siedzibie Spółki, w Warszawie albo z wykorzystaniem środków komunikacji elektronicznej.”

ust.~3: „Zawiadomienia mogą być przesyłane na adres poczty elektronicznej wpisany do rejestru akcjonariuszy lub wskazany Spółce, z zachowaniem terminów ustawowych.”
\end{Bylo}
\end{ContractClause}

\begin{ContractClause}{Sprawy Zastrzeżone dla Walnego Zgromadzenia}
\label{art:walne-zastrzezone}
\ZmianaKomentarz{4}{W lit.~i usunięto powołanie i odwołanie dyrektorów z katalogu spraw wymagających 75\% wszystkich głosów --- większości dla tych uchwał określa teraz §~\ref{art:rada} ust.~2 (powołanie i odwołanie z ważnych powodów: bezwzględna większość głosów oddanych; odwołanie bez ważnych powodów: 75\% wszystkich głosów). Zatwierdzenie wynagrodzenia dyrektorów i program ubezpieczenia pozostają w katalogu bez zmian.}
\begin{enumerate}
  ...
  \begin{enumerate}[label=\alph*)]
    ...
    \item \ZM zatwierdzenie wynagrodzenia dyrektorów oraz przyjęcie programu ubezpieczenia odpowiedzialności; powołanie i odwołanie dyrektorów następuje większościami określonymi w §~\ref{art:rada} ust.~2;
...
\begin{Bylo}
ust.~1 lit.~i: „powołanie i odwołanie dyrektorów, zatwierdzenie ich wynagrodzenia oraz przyjęcie programu ubezpieczenia odpowiedzialności;”
\end{Bylo}
\end{ContractClause}
...
\ZmianaKomentarz{10}{Domknięcie punktu~5 „Podsumowania audytu”: dotychczasowy ust.~8 pozwalał zastąpić uchwałę Rady Dyrektorów uchwałą Walnego Zgromadzenia także tam, gdzie uchwały Rady wymaga \emph{sama ustawa} (w szczególności decyzje strategiczne z art.~300$^{75}$ §~2 KSH) --- a nie ma pewności, że uchwała WZ może skutecznie zastąpić ustawowo wymaganą uchwałę Rady. Po zmianie fallback WZ działa wyłącznie w sprawach, w których wymóg uchwały Rady wynika tylko z niniejszej umowy; tam, gdzie uchwały Rady wymaga ustawa, transakcja czeka na przywrócenie zdolności decyzyjnej Rady (w szczególności przez powołanie dodatkowego dyrektora wolnego od konfliktu), a uchwała WZ może stanowić jedynie dodatkową zgodę właścicielską.}
\begin{enumerate}
  ...
  \item \ZM Jeżeli wskutek wyłączenia dyrektorów pozostających w konflikcie Rada Dyrektorów nie może podjąć wymaganej uchwały, stosuje się następujące zasady:
  \begin{enumerate}[label=\alph*)]
...
\ZmianaKomentarz{6}{Paragraf w całości NOWY --- przygotowuje umowę na rundę inwestycyjną. Dotychczas umowa nie przewidywała trybu wpuszczenia inwestora: każdy standardowy warunek term-sheetu wymagałby negocjowania zmian umowy pod presją czasu. Paragraf: (a) definiuje Kwalifikowaną Rundę, (b) tworzy zobowiązanie współdziałania w dobrej wierze po podjęciu uchwały kierunkowej (nadal 75\% --- nikt nie jest zmuszany do rundy, ale po decyzji nikt nie może jej blokować w szczegółach), (c) wyznacza katalog zwyczajowych warunków inwestorskich, które nie naruszają filozofii umowy, (d) podporządkowuje inwestora Kryterium Bezpieczeństwa EU/NATO. Prawo poboru (4/5 głosów przy jego wyłączeniu --- art.~300$^{106}$ KSH) i status emisji jako Sprawy Zastrzeżonej pozostają nienaruszone. DO WERYFIKACJI PRZEZ PRAWNIKA: skuteczność i granice zobowiązań do głosowania (ust.~3) w prawie polskim. Pełna mapa paragrafów przygotowujących rundę --- Załącznik nr~10.}
\begin{enumerate}
  \item \NOWE „Kwalifikowana Runda Finansowania” oznacza emisję nowych akcji Spółki skierowaną do jednego lub kilku inwestorów, z których każdy jest Dopuszczalnym Nabywcą i spełnia Kryterium Bezpieczeństwa EU/NATO (albo uzyskał zgodę Walnego Zgromadzenia zgodnie z §~\ref{art:dopuszczalny-nabywca}), jeżeli łączna cena emisyjna nowych akcji wynosi co najmniej \field{2\,000\,000 zł} albo emisja następuje przy wycenie Spółki przed emisją wynoszącej co najmniej \field{kwota}.
  \item \NOWE Rozpoczęcie Kwalifikowanej Rundy Finansowania wymaga uchwały kierunkowej Walnego Zgromadzenia podjętej większością 75\% wszystkich głosów, określającej co najmniej: widełki wyceny lub minimalną cenę emisyjną, maksymalną liczbę nowych akcji, dopuszczalny krąg inwestorów oraz ramowe warunki z ust.~4.
  \item \NOWE Po podjęciu uchwały kierunkowej każdy akcjonariusz zobowiązuje się współdziałać w dobrej wierze w celu przeprowadzenia Kwalifikowanej Rundy Finansowania na warunkach zgodnych z tą uchwałą, w szczególności: uczestniczyć w Walnych Zgromadzeniach zwołanych w związku z Rundą, głosować za uchwałami niezbędnymi do jej przeprowadzenia oraz zawrzeć zwyczajowe dokumenty transakcyjne. Zobowiązanie to nie obejmuje głosowania sprzecznego z bezwzględnie obowiązującymi przepisami prawa, uchwałą kierunkową albo interesem Spółki i nie zobowiązuje żadnego akcjonariusza do objęcia nowych akcji ani wniesienia dodatkowych środków.
  \item \NOWE Następujące zwyczajowe warunki inwestorskie mogą zostać przyznane w uchwale emisyjnej i dokumentach transakcyjnych Kwalifikowanej Rundy Finansowania bez konieczności odrębnej zmiany pozostałych postanowień niniejszej umowy, w granicach prawa: (a) uprzywilejowanie likwidacyjne bez prawa udziału (non-participating) do wysokości jednokrotności ceny emisyjnej; (b) ochrona antyrozwodnieniowa metodą szerokiej średniej ważonej (broad-based weighted average); (c) prawo nominacji jednego dyrektora albo obserwatora przy Radzie Dyrektorów, z zachowaniem §~\ref{art:rada} ust.~3; (d) prawa informacyjne; (e) prawo uczestnictwa w przyszłych emisjach proporcjonalnie do udziału (pro-rata). Warunki dalej idące, w szczególności uprzywilejowanie likwidacyjne z prawem udziału, ochrona antyrozwodnieniowa typu full ratchet albo prawo weta wykraczające poza katalog Spraw Zastrzeżonych, wymagają odrębnej uchwały Walnego Zgromadzenia podjętej większością 75\% wszystkich głosów.
  \item \NOWE Emisja akcji w ramach Kwalifikowanej Rundy Finansowania pozostaje Sprawą Zastrzeżoną i następuje zgodnie z §~\ref{art:walne-zastrzezone}, z zachowaniem zasad prawa poboru i większości wymaganych przez prawo dla jego ograniczenia lub wyłączenia.
  \item \NOWE Umowę przygotowują na Kwalifikowaną Rundę Finansowania w szczególności: §~\ref{art:akcje} i §~\ref{art:cap-table} (struktura akcji), §~\ref{art:program-motywacyjny} (pula ESOP), §~\ref{art:zwrotne-zbycie} (vesting założycielski), §~\ref{art:dopuszczalny-nabywca} i §~\ref{art:zbywanie} (weryfikacja inwestora), §~\ref{art:pierwszenstwo}, §~\ref{art:przylaczenie} i §~\ref{art:przymusowe-wspolzbycie} (obrót wtórny), §~\ref{art:wycena} (standard wyceny), §~\ref{art:finansowanie} ust.~4 (instrumenty zamienne) oraz §~\ref{art:walne-zastrzezone} (ład emisyjny); zestawienie informacyjne zawiera Załącznik nr~10.
\end{enumerate}

\begin{Bylo}
Paragraf nie istniał w wersji 0.8 --- całość jest nowa.
\end{Bylo}
\end{ContractClause}
...
\begin{enumerate}
  ...
  \item \ZM Załączniki nr 4--11 mają wyłącznie charakter informacyjny i porządkujący, nie stanowią części normatywnej niniejszej umowy i nie tworzą samodzielnych praw ani obowiązków.
\end{enumerate}

\ZmianaKomentarz{11}{W ust.~7 rozszerzono zakres z „4--9” na „4--11” w związku z dodaniem Załącznika nr~10 (mapa przygotowania pod rundę inwestycyjną) i nr~11 (punkty do weryfikacji podatkowej) --- oba wyłącznie informacyjne.}
\begin{Bylo}
ust.~7: „Załączniki nr 4--9 mają wyłącznie charakter informacyjny i porządkujący, nie stanowią części normatywnej niniejszej umowy i nie tworzą samodzielnych praw ani obowiązków.”
\end{Bylo}
\end{ContractClause}
...
\ZmianaKomentarz{7}{Dwie zmiany. Po pierwsze --- KOREKTA RACHUNKOWA: kolumna „Cena łączna” zawierała kwoty 50\,000 / 20\,000 / 10\,000 / 10\,000 / 10\,000 zł (suma 100\,000 zł), podczas gdy przy cenie emisyjnej 0,01 zł za akcję (§~\ref{art:akcje}) łączna cena emisyjna 1\,000\,000 akcji serii A wynosi 10\,000 zł; kwoty były dziesięciokrotnie zawyżone. Skorygowano do 5\,000 / 2\,000 / 1\,000 / 1\,000 / 1\,000 zł. Wartość wkładów może przewyższać cenę emisyjną --- §~\ref{art:wklady} ust.~3 wymaga jedynie „co najmniej”. Po drugie --- zgodnie ze zmianą §~\ref{art:wklady} dodano tabelę wkładów pieniężnych; ich suma stanowi kapitał akcyjny wykazywany przy rejestracji.}
...
\NOWE \textbf{Wkłady pieniężne Założycieli (§~\ref{art:wklady} ust.~1 lit.~d i ust.~4):}
...
\begin{Bylo}
Kolumna „Cena łączna”: A --- 50 000 zł; B --- 20 000 zł; C --- 10 000 zł; D --- 10 000 zł; E --- 10 000 zł. Tabela wkładów pieniężnych nie istniała.
\end{Bylo}
...
\begin{enumerate}
  ...
  \item \ZM \textbf{Mechanizm czasowy, jeżeli ma zastosowanie.} Założyciel Pierwotny wskazany w Załączniku nr 2 jako funkcjonalny podlega mechanizmowi stopniowego zwalniania akcji z obowiązku zbycia oraz obowiązkom dotyczącym Odejścia Usprawiedliwionego, Odejścia Dobrowolnego i Odejścia Zawinionego — §~\ref{art:zwrotne-zbycie} i Załącznik nr 2.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \ZM \textbf{Skutki ustania zaangażowania.} Obie grupy podlegają wspólnym definicjom Odejścia Usprawiedliwionego, Odejścia Dobrowolnego i Odejścia Zawinionego oraz odpowiadającym im zasadom pozostawienia lub obowiązkowego zbycia akcji --- §~\ref{art:zwrotne-zbycie}.
...
\NOWE \textbf{Nota rewizyjna 0.9.} Audyt odnosi się do tekstu umowy w wersji 0.8. Zmiany rewizji 0.9, oznaczone w tekście blokami [ZMIANA 1--11], nie były przedmiotem niniejszego audytu i wymagają odrębnej weryfikacji prawnej. Zestawienie zmian oraz ich relacja do „Podsumowania audytu” znajdują się w Nocie rewizyjnej na początku dokumentu.
...
\NOWE \textbf{Dopisek rewizji 0.9.} Rewizja 0.9 adresuje wszystkie pięć powyższych punktów: pkt 1 --- nowy ustęp o obowiązkach osoby niebędącej jeszcze akcjonariuszem w §~\ref{art:dopuszczalny-nabywca} [ZMIANA 3]; pkt 2 --- osadzenie lock-upu i zgody Spółki w art.~300$^{39}$ KSH w §~\ref{art:zbywanie} i §~\ref{art:okres-ograniczenia-zbywania} [ZMIANA 3]; pkt 3 --- oparcie §~\ref{art:dziedziczenie} na art.~300$^{41}$ §~1 KSH z określonymi warunkami spłaty [ZMIANA 9]; pkt 4 --- miejsce fizyczne WZ i e-mail z rejestru akcjonariuszy w §~\ref{art:wz} [ZMIANA 8]; pkt 5 --- rozdzielenie umownego i ustawowego wymogu uchwały Rady w §~\ref{art:konkurencja} ust.~8 [ZMIANA 10]. Skuteczność przyjętych rozwiązań wymaga potwierdzenia przez prawnika w punktach oznaczonych „DO WERYFIKACJI”.
...
\ZmianaKomentarz{6}{Załącznik w całości NOWY (informacyjny). Odpowiada na pytanie: „które paragrafy umowy przygotowują rundę inwestycyjną i czemu odpowiadają w typowym term-sheecie VC”.}
...
\ZmianaKomentarz{11}{Załącznik w całości NOWY (informacyjny). Zbiera znane punkty sporne podatkowe wymagające analizy doradcy podatkowego przed podpisaniem umowy i przed pierwszym grantem z programu motywacyjnego.}
