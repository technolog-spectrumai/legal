...
\BusinessPlanVersionText{Wersja 0.9.4-A --- wariant inwestycyjny}
...
\hypersetup{
  pdftitle={Basilisk Systems P.S.A. --- projekt umowy spółki --- wariant inwestycyjny},
...
\BusinessPlanTitlePage
  {Basilisk Systems}
  {Wersja 0.9.4-A --- wariant inwestycyjny}
  {Umowa P.S.A.}
