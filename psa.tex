...
\newcommand{\CriticalConsultationBox}[1]{%
  \begin{tcolorbox}[
    ...
    colback=red!3,colframe=red!60!black,coltitle=white,
...
\BusinessPlanAuthorsText{Basilisk Systems --- czysty projekt umowy P.S.A.}
\BusinessPlanConfidentialText{Projekt umowy --- czysty tekst normatywny z integralnymi Załącznikami nr 1--3}
\BusinessPlanFooterText{Basilisk Systems --- projekt umowy P.S.A.}
\BusinessPlanVersionText{Dokument III}
\hypersetup{pdftitle={Basilisk Systems P.S.A. --- projekt umowy spółki},pdfauthor={Basilisk Systems --- czysty projekt umowy}}
\begin{document}
\BusinessPlanTitlePage
  {Basilisk Systems}
  {Dokument III}
  {Czysty tekst umowy bez pytań i komentarzy}
