...
\begin{enumerate}
  ...
  \item Załączniki nr 4--7 mają wyłącznie charakter informacyjny i porządkujący, nie stanowią części normatywnej niniejszej umowy i nie tworzą samodzielnych praw ani obowiązków.
\end{enumerate}
\end{ContractClause}
...
\clearpage
\section*{Załącznik nr 4 — Obowiązki akcjonariusza — zestawienie informacyjne}
\addcontentsline{toc}{section}{Załącznik nr 4 — Obowiązki akcjonariusza — zestawienie informacyjne}
\label{annex:obowiazki-akcjonariusza}

\textbf{Status załącznika.} Załącznik ma charakter wyłącznie informacyjny i porządkujący. Nie tworzy nowych obowiązków ani nie rozszerza obowiązków wynikających z tekstu umowy. W razie rozbieżności rozstrzygające znaczenie ma właściwe postanowienie umowy wskazane poniżej przez odesłanie do paragrafu.

\subsection*{1. Obowiązki dotyczące każdego akcjonariusza}
\begin{enumerate}
...
\subsection*{2. Dodatkowe obowiązki Założyciela Pierwotnego}
\begin{enumerate}
...
\subsection*{3. Dodatkowe obowiązki Założyciela Funkcjonalnego Serii F i Akcjonariusza Funkcjonalnego}
\begin{enumerate}
...
\subsection*{4. Obowiązki uruchamiane przez szczególne zdarzenia}
\begin{enumerate}
...
\subsection*{5. Brak automatycznego obowiązku dalszego finansowania}
