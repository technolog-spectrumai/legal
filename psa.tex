...
Rewizja 0.9.3 --- lit.~e w brzmieniu rewizji 0.9 (i 0.8): „porzuceniem obowiązków albo odmową ich wykonywania przez co najmniej 30 dni po bezskutecznym pisemnym wezwaniu.” (bez zdania o rezygnacji z okresem przejściowym).
\end{Bylo}
\end{ContractClause}
